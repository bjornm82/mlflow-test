...
def main(argv):
    with mlflow.start_run():
        ...
        new_model = tf.keras.models.load_model('s3://druid-index-eu-west-1.s3-eu-west-1.amazonaws.com/mlflow/4/0277d7cf6de545f2bd9dc6f2a08bbeb4/artifacts/model/tfmodel/')
